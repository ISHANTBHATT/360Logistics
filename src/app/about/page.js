  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 py-40 px-4 sm:px-6 lg:px-8">
      ...
      <motion.div
        ...
        variants={fadeInUp}
      >
        <div className="bg-gradient-to-r from-[#5db5e9]/10 to-primary-foreground/10 p-8 rounded-3xl">
          <h1 className="text-4xl md:text-5xl font-bold pb-6 bg-gradient-to-r from-primary to-primary-foreground bg-clip-text text-transparent">
      ...
      >
        <motion.div
          className="mb-16 bg-gradient-to-r from-[#5db5e9]/10 to-primary-foreground/10 p-8 rounded-3xl"
          variants={fadeInUp}
        >
          <h2 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-primary to-primary-foreground mb-6">
            Our Vision
          </h2>
        ...
        <motion.div
          className="bg-gradient-to-l from-[#5db5e9]/10 to-primary-foreground/10 p-8 rounded-3xl"
          variants={fadeInUp}
        >
          <h2 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-primary to-primary-foreground mb-6">
            Our Mission
      ...
      <motion.div
        ...
        variants={fadeInUp}
      >
        <h2 className="text-4xl font-bold text-center text-transparent bg-clip-text bg-gradient-to-r from-primary to-primary-foreground mb-12">
          Our Core Values
        </h2>
